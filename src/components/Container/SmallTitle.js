...
export default function SmallTitle() {
	return (
		<div className="flex flex-row">
			<div className="flex float-row justify-center items-center gap-1 rounded-full shadow-md bg-transparent p-2">
			...
			<div className="flex flex-row gap-2 ml-2 font-semibold">
				<div className="flex items-center">4 adultes </div>
				<div className="flex items-center">2 enfants</div>
				<div className="flex items-center"> | </div>
				<div className="flex items-center"> 2 SGL</div>
